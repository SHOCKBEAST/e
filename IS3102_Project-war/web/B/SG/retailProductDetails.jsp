...
<html> <!--<![endif]-->
    ...
    <body>
        <%
            ...
            /*insert code here*/        System.out.println("retailProduct size:" + retailProducts.size());
      
          for(int i=0; i <  retailProducts.size(); i+=1) { 
                 String input = retailProducts.get(i).getSKU();
            if(sku.equals(input)){
     

 String image =   retailProducts.get(i).getImageUrl();
 String category =  retailProducts.get(i).getCategory();
  String description =  retailProducts.get(i).getDescription();
  double price =  retailProducts.get(i).getPrice();
 String name =  retailProducts.get(i).getName();
        %>
        <div class="body">
                            ...
                            <div class="col-md-6">
                                <div class="summary entry-summary">
                                    ...
                                    <div class="product_meta">
                                        <span class="posted_in">Category: <a rel="tag" href="#"><%=category%></a></span>
                                    </div>
                                    <br/><br/>
<%
}else{
